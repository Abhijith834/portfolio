 ...
 */var Gg;function zx(){if(Gg)return mo;Gg=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,u){var h=null;if(u!==void 0&&(h=""+u),l.key!==void 0&&(h=""+l.key),"key"in l){u={};for(var d in l)d!=="key"&&(u[d]=l[d])}else u=l;return l=u.ref,{$$typeof:o,type:r,key:h,ref:l!==void 0?l:null,props:u}}return mo.Fragment=e,mo.jsx=i,mo.jsxs=i,mo}var Vg;function Fx(){return Vg||(Vg=1,Nf.exports=zx()),Nf.exports}var ft=Fx(),Of={exports:{}},ae={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wg;function Gx(){return Wg||(Wg=1,function(o){function e(N,K){var W=N.length;N.push(K);t:for(;0<W;){var yt=W-1>>>1,D=N[yt];if(0<l(D,K))N[yt]=K,N[W]=D,W=yt;else break t}}function i(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var K=N[0],W=N.pop();if(W!==K){N[0]=W;t:for(var yt=0,D=N.length,$=D>>>1;yt<$;){var xt=2*(yt+1)-1,Mt=N[xt],Z=xt+1,mt=N[Z];if(0>l(Mt,W))Z<D&&0>l(mt,Mt)?(N[yt]=mt,N[Z]=W,yt=Z):(N[yt]=Mt,N[xt]=W,yt=xt);else if(Z<D&&0>l(mt,W))N[yt]=mt,N[Z]=W,yt=Z;else break t}}return K}function l(N,K){var W=N.sortIndex-K.sortIndex;return W!==0?W:N.id-K.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,v=null,x=3,y=!1,b=!1,C=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,O=typeof setImmediate<"u"?setImmediate:null;function U(N){for(var K=i(p);K!==null;){if(K.callback===null)r(p);else if(K.startTime<=N)r(p),K.sortIndex=K.expirationTime,e(m,K);else break;K=i(p)}}function V(N){if(C=!1,U(N),!b)if(i(m)!==null)b=!0,F||(F=!0,tt());else{var K=i(p);K!==null&&ut(V,K.startTime-N)}}var F=!1,H=-1,k=5,w=-1;function A(){return M?!0:!(o.unstable_now()-w<k)}function I(){if(M=!1,F){var N=o.unstable_now();w=N;var K=!0;try{t:{b=!1,C&&(C=!1,B(H),H=-1),y=!0;var W=x;try{e:{for(U(N),v=i(m);v!==null&&!(v.expirationTime>N&&A());){var yt=v.callback;if(typeof yt=="function"){v.callback=null,x=v.priorityLevel;var D=yt(v.expirationTime<=N);if(N=o.unstable_now(),typeof D=="function"){v.callback=D,U(N),K=!0;break e}v===i(m)&&r(m),U(N)}else r(m);v=i(m)}if(v!==null)K=!0;else{var $=i(p);$!==null&&ut(V,$.startTime-N),K=!1}}break t}finally{v=null,x=W,y=!1}K=void 0}}finally{K?tt():F=!1}}}var tt;if(typeof O=="function")tt=function(){O(I)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,ct=et.port2;et.port1.onmessage=I,tt=function(){ct.postMessage(null)}}else tt=function(){_(I,0)};function ut(N,K){H=_(function(){N(o.unstable_now())},K)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(N){N.callback=null},o.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):k=0<N?Math.floor(1e3/N):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(N){switch(x){case 1:case 2:case 3:var K=3;break;default:K=x}var W=x;x=K;try{return N()}finally{x=W}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(N,K){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var W=x;x=N;try{return K()}finally{x=W}},o.unstable_scheduleCallback=function(N,K,W){var yt=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?yt+W:yt):W=yt,N){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=W+D,N={id:g++,callback:K,priorityLevel:N,startTime:W,expirationTime:D,sortIndex:-1},W>yt?(N.sortIndex=W,e(p,N),i(m)===null&&N===i(p)&&(C?(B(H),H=-1):C=!0,ut(V,W-yt))):(N.sortIndex=D,e(m,N),b||y||(b=!0,F||(F=!0,tt()))),N},o.unstable_shouldYield=A,o.unstable_wrapCallback=function(N){var K=x;return function(){var W=x;x=K;try{return N.apply(this,arguments)}finally{x=W}}}}(If)),If}var qg;function Vx(){return qg||(qg=1,Bf.exports=Gx()),Bf.exports}var zf={exports:{}},An={};/**
 * @license React
...
`)+`
`+_);const O=B+M+h,U=B+_+d,V=G_(l,l.VERTEX_SHADER,O),F=G_(l,l.FRAGMENT_SHADER,U);l.attachShader(C,V),l.attachShader(C,F),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function H(I){if(o.debug.checkShaderErrors){const tt=l.getProgramInfoLog(C).trim(),et=l.getShaderInfoLog(V).trim(),ct=l.getShaderInfoLog(F).trim();let ut=!0,N=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(ut=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,V,F);else{const K=k_(l,V,"vertex"),W=k_(l,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
